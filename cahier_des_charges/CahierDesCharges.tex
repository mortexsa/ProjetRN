...
\section{Contraintes sur le Projet}
	...
	\begin{itemize}
			...
			\item Cahier des spécifications : 18 avril 2018
			\item Rendu final : 25 mai 2018
		\end{itemize}
...
\section{Glossaire et Conventions de Dénomination}
	\begin{itemize}
		...
		\item \emph{Sigmoïde : }Fonction ramenant la valeur d'entrée à une valeur entre 0 et 1 (comme l'activation) défini tel quel : 
			\[
	...
	\subsection{Organigramme et Liens entre Modules}
		...
		\paragraph{Connections entre les modules :}
			\begin{enumerate}
				...
				\item Après l'estimation d'une solution par le réseau de neurone, la solution est envoyée à l'interface. De plus, pour la visualisation de la méthode de fonctionnement du réseau, les matrices contenant les poids doivent également être envoyées à l'interface.
				...
				\item Afin de sauvegarder un réseau de neurone, les différentes matrices et vecteurs contenant les poids et les biais du réseau de neurone doivent être envoyés au gestionnaire d'entrées/sorties.
...
\section{Exigences Non Fonctionnelles}
	...
	\subsection{Facilité D'utilisation et Facteur Humain}
		Le produit nécessitera une compréhension de la langue française. L'application aidera l'utilisateur à ne pas faire d'erreur en lui proposant des conseil et en utilisant des messages de confirmation pour les actions tel que la suppression.
...
\section{Implémentations Supplémentaires Possibles}
	Afin d'améliorer les performances de l'application, il serait possible d'opter pour la version stochastique de la descente de gradient où la rétro-propagation est effectuée sur la moyenne de l'erreur de plusieur images et non plus sur l'erreur de chaque image.
...
\section{Conclusion}
	%a terminer ;)
	Il serait plus adéquat d'utiliser le langage C plutôt qu'un autre langage de part la nature même du langage qui est procédurale : pas d'interdépendance des différents éléments de notre programme; un seul algorithme complexe à développer ; utilisation des structures de données bien spécifiques (tableaux, matrices) et on ajoutera que la conception de notre application est plutôt linéaire.\\\\Nous citons aussi d'autres points forts du langage :
	\begin{itemize}
...
\section{Annexe}
	\subsection{annexe 1}
		...
		\begin{center}
			\includegraphics[height=244, width=300]{dcu.png}
		\end{center}
	...
	\subsection{annexe 2}
		...
		\begin{center}
			\includegraphics[height=224, width=300]{organigrame.png}
		\end{center}
	...
	\subsection{annexe 3}
		...
		\begin{center}
			\includegraphics[height=384, width=600, angle=270]{interface.png}
		\end{center}
