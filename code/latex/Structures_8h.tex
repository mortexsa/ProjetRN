...
\begin{DoxyCompactList}\small\item\em definie les composantes rgb d\textquotesingle{}un pixel \end{DoxyCompactList}\item 
struct \hyperlink{structImage}{Image}
\begin{DoxyCompactList}\small\item\em contient chaque pixel deffinissant une image ainsi que la taille de celle ci \end{DoxyCompactList}\item 
struct \hyperlink{structCOUCHE}{C\+O\+U\+C\+HE}
\begin{DoxyCompactList}\small\item\em decrit une couche d\textquotesingle{}un réseau de neurone \end{DoxyCompactList}\item 
struct \hyperlink{structINFO__RN}{I\+N\+F\+O\+\_\+\+RN}
\begin{DoxyCompactList}\small\item\em contient les information concernant un réseau de neurones \end{DoxyCompactList}\item 
struct \hyperlink{structRN}{RN}
\begin{DoxyCompactList}\small\item\em defini un réseau de neurones \end{DoxyCompactList}\item 
struct \hyperlink{structApprentissage}{Apprentissage}
\begin{DoxyCompactList}\small\item\em regroupe un couple données d\textquotesingle{}entré et sortie attendue necessaire lors de l\textquotesingle{}apprentissage \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Macros}
\begin{DoxyCompactItemize}
\item 
