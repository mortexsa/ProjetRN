...
\section{Signatures des Fonctions}
	\subsection{Gestionnaires d'apprentissage}
		\begin{flushleft}
			\textcolor{myblue}{\textbf{void}} BackProp(\textcolor{myblue}{\textbf{RN*}}, \textcolor{myblue}{\textbf{Image*}} ,\textcolor{myblue}{\textbf{char*}}, \textcolor{myblue}{\textbf{float}});
			\medbreak
			...
			Le deuxième tableau est a deux dimension car DELTA\_M est disponible au moment ou cette opération est effectué, on va donc l'utiliser plutot que de créer un autre tableau pour stocker le résultat.
			\bigbreak
	...
	\subsection{Gestionnaire du réseau de neurones}
		\begin{flushleft}
			...
			\medbreak
			\bigbreak
			\textcolor{myblue}{\textbf{void}} AjoutFin(\textcolor{myblue}{\textbf{RN}}, \textcolor{myblue}{\textbf{int}});
			\medbreak
			\bigbreak
			\textcolor{myblue}{\textbf{void}} Propagation(\textcolor{myblue}{\textbf{Image*}}, \textcolor{myblue}{\textbf{RN}});
			\medbreak
			\bigbreak
			\textcolor{myblue}{\textbf{char**}} Reconnaissance(\textcolor{myblue}{\textbf{RN}});
			\medbreak
			\bigbreak
			\textcolor{myblue}{\textbf{void}} MultiplicationMatriceVecteur(\textcolor{myblue}{\textbf{float**}},  \textcolor{myblue}{\textbf{float*}},  \textcolor{myblue}{\textbf{float*}},  \textcolor{myblue}{\textbf{int}},  \textcolor{myblue}{\textbf{int}});
			\medbreak
			\bigbreak
